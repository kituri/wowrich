...
//熔火之心
public class eUS_SW implements CustomRequest {
	...
	private final int Type = Constants.TYPE_US_SW;
	private final int BattleLV = 12;
	// 20% 30% 40% 16 14 12
//	private final int Difficulty = 12;
	...
	private int[] BossDifficulty = { 24, 27, 30 };
	//上下随机变动难度值
	...
	//
	public eUS_SW(Context _context, EvenOverRequest evenOverRequest) {
		...
		case 2:
			if(eBattleEven.RandomPer(80)){
				...
				Constants.ItemMessage = "战胜BOSS后，发现了一个宝箱。" + Constants.ItemMessage;
						...
						Constants.player[Constants.playerIndex].addEquips(4);
						Constants.ItemMessage = "打开宝箱，获得了 【" + Constants.player[Constants.playerIndex].getEquipsByID(4)
						.getName() + "】 。";
				}
